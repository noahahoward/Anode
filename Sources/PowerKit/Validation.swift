...
public final class ModelValidator {
    ...
    private static func synthetic(scale: BatteryScale, smoothed: Double,
        ...
        return PowerMonitor.Snapshot(drains: [], apps: [],
                                     ...
                                     smcTotal_W: nil, smcGain: nil, cpuRail_W: nil, display_W: nil, memory_W: nil, storage_W: nil, usb_W: nil, usbHasUnmeasured: false, usbHasRemembered: false, usbDevices: [], displayIsMeasured: false, baseline_W: nil,
                                     didJump: false,
